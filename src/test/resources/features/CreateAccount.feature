...
Feature: Create Account feature
  ...
  Scenario: Create Account in the app
    ...
    When I fill the creation account form with lastName "DOMES", firstName "Lucas", birthDate "12/10/1996", email "Lucas.Doslmes@gmail.com" and password "LucasDomes1234"
